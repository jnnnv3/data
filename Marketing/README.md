...
분석 결과 평균 ROI는 5.50으로 전체적으로 수익성을 확보하고 있었으나, 약 38.9%의 캠페인은 손실을 기록하여 성과 편차가 크게 나타났다. 또한 채널 및 캠페인 유형별 ROI 차이는 크지 않았으며, 성과 차이는 주로 CPC와 Conversion Rate의 차이에서 발생하는 것으로 확인되었다.

특히 고성과 캠페인은 낮은 CPC와 높은 전환율을 보인 반면, 저성과 캠페인은 높은 CPC와 낮은 전환율이 동시에 나타났다. 이를 통해 마케팅 성과는 채널 중심이 아니라 캠페인 단위의 운영 효율성에 의해 결정된다는 점을 확인할 수 있었다.

따라서 예산 최적화를 위해서는 채널별 예산 배분보다 CPC 절감 및 전환율 개선 가능성이 높은 캠페인에 우선적으로 투자하는 전략이 필요하다.
...
따라서 마케팅 예산의 투자 효율을 극대화하기 위해서는 채널 중심의 예산 배분보다 캠페인 단위의 성과 기반 운영 체계를 구축하고, CPC 절감 및 전환율 개선이 가능한 캠페인에 예산을 우선 배분하는 전략이 필요하다. 또한 성과가 낮은 캠페인에 대해서는 타겟팅, 광고 소재, 랜딩페이지 최적화 등을 통해 전환 효율을 개선할 필요가 있다.